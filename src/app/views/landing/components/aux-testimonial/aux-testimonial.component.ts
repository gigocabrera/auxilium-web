...
@Component({
  selector: "app-aux-testimonial",
  templateUrl: "./aux-testimonial.component.html",
  styleUrls: ["./aux-testimonial.component.scss"]
})
export class AuxTestimonialComponent implements OnInit {
