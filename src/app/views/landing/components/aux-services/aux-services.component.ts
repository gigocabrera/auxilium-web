...
@Component({
  selector: "app-aux-services",
  templateUrl: "./aux-services.component.html",
  styleUrls: ["./aux-services.component.scss"]
})
export class AuxServicesComponent implements OnInit {
